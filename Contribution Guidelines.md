...
1. Before reporting a new issue, look through the project’s [issue tracker](issues) to check if the issues has already been reported.
...
1. Find the relevant issue in the project [issue tracker](issues).
